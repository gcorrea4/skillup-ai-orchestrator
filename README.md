...
### Project Overview
**SkillUp** is a hybrid AI assistant designed to generate personalized learning paths. It acts as an educational mentor that maps the user's current knowledge and suggests a logical roadmap to master new skills (IT, Design, or Business).
...
<div align="center">
  <img src="img/print-chat-2.png" alt="Telegram Bot Preview" width="400">
...
- `/flows`: Contains `.json` files for Node-RED and Watson Assistant.
